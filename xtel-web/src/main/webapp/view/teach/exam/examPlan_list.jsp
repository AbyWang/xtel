        ...
        {title: '上传时间',field: 'TIME', align: 'center', valign: 'middle'},
         {title: '考试方式',field: 'TYPE', align: 'center', valign: 'middle',
             ...
             {title: '操作', align: 'center', valign: 'middle', formatter: 
                         ...
                         data[index]=row;
                    //     return   ' <a  type="button" class="btn btn-primary btn-xs"  href="examController/gotoCheckExam"><span class="glyphicon glyphicon-dashboard" aria-hidden="true"></span>阅卷</button>';
             }}]  };
  </script>
</body>
</html>
