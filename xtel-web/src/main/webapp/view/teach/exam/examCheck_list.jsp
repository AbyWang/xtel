...
$(function () {
    ...
    var table = new BSTable("listAllLesson",path+ "/examController/listExamRecord", defaultColunms);
    table.init();
});
...
listAllLesson.initColumn= function () {
    return [
        ...
        {title: '学员姓名',field:'USERNAME', align: 'center', valign: 'middle'},
        {title: '考试时间',field:'TIME', align: 'center', valign: 'middle',
